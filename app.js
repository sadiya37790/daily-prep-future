  ...
  googleLoginBtn.addEventListener('click', () => {
    ...
    popup.document.write(`
      ...
      <head>
        ...
        <style>
          body { font-family: Roboto, Arial, sans-serif; background: #fff; color: #202124; padding: 40px; text-align: center; }
          .logo { width: 74px; margin-bottom: 20px; }
          h2 { font-size: 24px; font-weight: 400; margin-bottom: 8px; }
          p { color: #5f6368; font-size: 16px; margin-bottom: 40px; }
          .account-box { border: 1px solid #dadce0; border-radius: 8px; padding: 15px; display: inline-flex; align-items: center; gap: 15px; cursor: pointer; width: 280px; text-align: left; transition: background 0.2s; }
          .account-box:hover { background: #f8f9fa; }
          .avatar { width: 35px; height: 35px; border-radius: 50%; background: #8b5cf6; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 18px; }
          .email { font-size: 12px; color: #5f6368; }
        </style>
      </head>
      <body>
        <svg class="logo" viewBox="0 0 24 24" width="30" height="30" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="account-box" id="select-account">
          <div class="avatar">G</div>
          <div>
            <div style="font-weight:600;">Google Student</div>
            <div class="email">student.prep@gmail.com</div>
          </div>
        </div>
        <script>
          document.getElementById('select-account').onclick = function() {
